TRUTH = [
    ...
    "Apabila kamu cewe bersedia kah untuk menjadi pacar owner ku @DANTEHAIMIYA",
    ...
    "si @DANTEHAIMIYA menurut ku dia ganteng, coba deh kamu chat, trus ajak pacaran hehe ⚠️WARNING ini khusus cewe ya!",
